 ...
 **/
function hpo_get_object_id( $obj ) {
	$obj_id = null;
 ...
 **/
function hpo_get_object_field_id( $obj ) {
	$field_id = null;
 ...
 **/
function hpo_get_attachment_src_by_size( $id, $size ) {
 ...
 **/
function hpo_get_theme_mod_default( $theme_mod, $defaults=HPO_THEME_CUSTOMIZER_DEFAULTS ) {
 ...
 **/
function hpo_get_theme_mod_or_default( $theme_mod, $defaults=HPO_THEME_CUSTOMIZER_DEFAULTS ) {
	$default = hpo_get_theme_mod_default( $theme_mod, $defaults );
 ...
 **/
function hpo_is_content_empty($str) {
